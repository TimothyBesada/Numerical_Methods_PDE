...
[u_1, K_global_1, F_global_1] = FEM_Gauss(n_elements, a, f, g, @Gauss1Point);

% Använd FEM med tvåpunkts Gausskvadratur
[u_2, K_global_2, F_global_2] = FEM_Gauss(n_elements, a, f, g, @Gauss2Points);

% Beräkna referenslösningen
[u_ref, ~, ~] = FEM_Gauss(n_elements_ref, a, f, g, @Gauss2Points);
